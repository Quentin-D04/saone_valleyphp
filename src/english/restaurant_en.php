...
<main>
    ...
    <a class="carte" href="../img_cartes/<?php echo htmlspecialchars($menu['carte']); ?>" download="menu.pdf">Download the PDF</a>
    ...
    <div class="heures_images">
        <ul class="horaires_resto">
            ...
            <li class="heures">Closed<br>11:45 AM - 1:30 PM<br>11:45 AM - 1:30 PM<br>11:45 AM - 1:30 PM, 7:00 PM - 9:00 PM<br>11:45 AM - 1:30 PM, 7:00 PM - 10:00 PM<br>11:45 AM - 1:30 PM, 7:00 PM - 9:00 PM<br>11:45 AM - 1:30 PM, 7:00 PM - 9:00 PM</li>
        </ul>
    ...
    <div class="reseaux">
        <ul class="suivre">
            <li>
                <h3 class="h3_resto">Follow us!</h3>
            </li>
        ...
        <ul class="suivre">
            <li>
                <h3 class="h3_restos">Contact us!</h3>
            </li>

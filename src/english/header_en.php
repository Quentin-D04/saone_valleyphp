    ...
    <nav>
      <ul>
        ...
        <li class="menu dropdown">
          <a href="#">Languages</a>
          <ul class="submenu">
            <li><a href="../code/chargement_site.php?type=accueil"><img src="../assets/img/fr-FR 1.png" alt="French flag"></a></li>
            <li><a href="../code/chargement_site.php?type=home"><img src="../assets/img/en-GB 1.png" alt="English flag"></a></li>
          </ul>
        </li>
      </ul>
    </nav>
